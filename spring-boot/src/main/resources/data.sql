...
insert into account (id,email,name,hash_password) values(1,'calvin.xiao@erian.io','Calvin','+2MunThvGcEfdYIFlT4NQQHt6z4=');
insert into account (id,email,name,hash_password) values(2,'david.wang@erian.io','David','+2MunThvGcEfdYIFlT4NQQHt6z4=');
