/*******************************************************************************
 * Copyright (c) 2005, 2014 erian.github.io
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 *******************************************************************************/
package org.erian.modules.test.log;
...
public class LogbackListAppenderTest {
	...
	public void addAndRemoveAppender() {
		...
		// name
		appender.clearLogs();
		appender.addToLogger("org.erian.modules.test.log");
		logger.warn(testString);
		assertThat(appender.getFirstLog()).isNotNull();

		appender.clearLogs();
		appender.removeFromLogger("org.erian.modules.test.log");
		logger.warn(testString);
		assertThat(appender.getFirstLog()).isNull();
	}
}
