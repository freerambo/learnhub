...
package org.erian.examples.bootapi.functional;
...
import org.erian.modules.test.data.RandomData;
...
public class BookEndpointTest extends BaseFunctionalTest {
	...
	public void fullBorrowProcess() {
		// 发起请求
		String token = login("david.wang@erian.io");
